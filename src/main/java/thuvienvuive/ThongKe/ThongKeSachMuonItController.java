...
public class ThongKeSachMuonItController implements Initializable {
    Stage stage;
    @FXML
    ...
    public void setAction(){
                ...
                public void handle(MouseEvent mouseEvent) {
                        ...
                        ObservableList<ThongKeSachMuonDTO> List;
                        {
                            try {
                                    ...
                                    List = ThongkeBus.getSachMuonIt(FromDate.getValue(), ToDate.getValue());
                                    InsertTableSachIt(List);
                            } catch (Exception e) {
                                e.printStackTrace();
                            }
                        }
        ...
        XuatExcel.setOnMouseClicked(new EventHandler<MouseEvent>() {
            @Override
            public void handle(MouseEvent mouseEvent) {
                Excel.xuatFileExcelThongKeSachMuonIt(FromDate.getValue(), ToDate.getValue());
            }
        });
        XuatPDF.setOnMouseClicked(new EventHandler<MouseEvent>() {
            @Override
            public void handle(MouseEvent mouseEvent) {
                xuatPDF.writeThongKeSachMuonIt(FromDate.getValue(),ToDate.getValue());
            }
        });
    }
    ...
    public void InsertTableSachIt(ObservableList<ThongKeSachMuonDTO> List){
